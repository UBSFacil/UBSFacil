...
-- USUARIO ADM DE TESTE (para testar o botão "Entrar como ADM" no front-end React)
-- Login: adm@ubsfacil.com  |  Senha: admin123
INSERT INTO usuarios (nome, cpf, email, sus_cartao, senha_hash, is_admin) VALUES
('Administrador UBSFacil', '000.000.000-00', 'adm@ubsfacil.com', '000000000000000', '$2b$12$AlAWJcOy7dFryVAGCam7j.Texd9FjMOtb0pBQzCxpuj9lHlw5nnc6', true);
