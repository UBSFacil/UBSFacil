    ...
    <>
      ...
      >
        ...
        <div className={styles.actions}>
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }}>
            {isAdmin ? (
              <Link to="/admin" className={styles.adminBtn}>Painel ADM</Link>
            ) : (
              <Link to="/login?admin=1" className={styles.adminBtn}>Entrar como ADM</Link>
            )}
          </motion.div>
        </div>
          ...
          <>
            ...
            >
              ...
              <div className={styles.drawerBtns}>
                ...
                {isAdmin ? (
                  <Link to="/admin" className={`${styles.adminBtn} btn-full`}>Painel ADM</Link>
                ) : (
                  <Link to="/login?admin=1" className={`${styles.adminBtn} btn-full`}>Entrar como ADM</Link>
                )}
              </div>
            </motion.div>
          </>
